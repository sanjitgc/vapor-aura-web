...
const storeLocations = [
    {
        ...
        hours: [
            { day: "Monday", time: "7 AM – 12 AM" },
            { day: "Tuesday", time: "7 AM – 12 AM" },
            { day: "Wednesday", time: "7 AM – 12 AM" },
            { day: "Thursday", time: "7 AM – 1 AM" },
            { day: "Friday", time: "7 AM – 1 AM" },
            { day: "Saturday", time: "7 AM – 1 AM" },
            { day: "Sunday", time: "7AM – 12 AM" },
        ],
    },
    {
